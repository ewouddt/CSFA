...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in if ((ncol(CSresult@permutation.object[[1]]) == B)) \{: argument is of length zero}}\end{kframe}
\end{knitrout}
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
## Correlation_Pearson  0.9547908   0.9102831
## Correlation_Spearman 0.8754101   0.7146388
## 
## $adj.pvalues
##                      CLoadings CRankScores
## Correlation_Pearson  0.9497074   0.9423659
## Correlation_Spearman 0.5733172   0.5346304
\end{verbatim}
\begin{alltt}
