...
<<ZG,echo=TRUE,eval=TRUE,cache=FALSE,fig.keep="high",fig.pos='H',out.width="11cm",fig.align='center',fig.cap="CSanalysis Graphs for CSzhang">>= 
...
<<MFA,echo=TRUE,eval=TRUE,cache=FALSE,fig.keep="high",fig.show='hold',fig.pos='H',out.width='9cm',out.height='10cm',fig.align='left',fig.cap="CSanalysis Graphs for CSfma">>= 
...
<<MFA2,echo=TRUE,eval=TRUE,cache=FALSE,fig.keep="high",fig.show='hold',fig.pos='H',out.width='9cm',out.height='10cm',fig.align='left',fig.cap="CSanalysis Graphs for CSfma">>= 
...
<<MFA3,echo=TRUE,eval=TRUE,cache=FALSE,fig.keep="high",fig.show='hold',fig.pos='H',out.width='9cm',out.height='10cm',fig.align='left',fig.cap="CSanalysis Graphs for CSfma">>= 
...
<<FABIA,echo=TRUE,eval=TRUE,cache=FALSE,message=FALSE,results='hide',fig.keep="high",fig.show='hold',fig.pos='H',out.width='9cm',out.height='10cm',fig.align='left',fig.cap="CSanalysis Graphs for CSfabia">>= 
...
<<CSpermuteplots,echo=TRUE,eval=TRUE,cache=FALSE,message=FALSE,results='hide',fig.keep="high",fig.show='hold',fig.pos='H',out.width='9cm',out.height='10cm',fig.align='left',fig.cap="CSpermute graphs for MFA result">>=
out_MFA <- CSpermute(refMat,querMat,out_MFA,B=250,method.adjust="BH",
		which=c(1,2),cmpd.hist=c(23,99),plot.type="sweave")
@
<<CSpermuteplots2,echo=TRUE,eval=TRUE,cache=FALSE,message=FALSE,results='hide',fig.keep="high",fig.show='hold',fig.pos='H',out.width='9cm',out.height='10cm',fig.align='left',fig.cap="CSpermute graphs for MFA result">>=
out_MFA <- CSpermute(refMat,querMat,out_MFA,B=250,method.adjust="BH",
...
<<CScompare,echo=TRUE,eval=TRUE,cache=FALSE,message=FALSE,fig.keep="high",fig.show='hold',fig.pos='H',out.width='9cm',out.height='10cm',fig.align='left',fig.cap="Compare CSresults">>=
